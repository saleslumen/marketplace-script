/**
 * @description Update a DNS record. PATCH /zones/{zone_id}/dns_records/{dns_record_id}. name, ttl, and type are required. Other input keys are the documented record body and are sent unchanged.
 * @param {Object} input
 ...
 */
async function updateDnsRecord(input) {
  ...
  return cloudflareRequest(path, "PATCH", { body: omit(req, DNS_RECORD_BODY_OMIT) });
}
