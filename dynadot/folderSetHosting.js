/**
 * PUT /restful/v2/folders/{folder_name}/hosts
 * @see https://www.dynadot.com/domain/api-document#folder_set_hosting
 * @param {Object} input
 ...
 */
async function folderSetHosting(input) {
  return dynadotRest({
    method: "PUT",
    path: "/folders/{folder_name}/hosts",
    fields: [
