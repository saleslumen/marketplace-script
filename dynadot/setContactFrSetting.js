/**
 * PUT /restful/v2/contacts/{contact_id}/set_fr_setting
 * @see https://www.dynadot.com/domain/api-document#set_contact_fr_setting
 * @param {Object} input
 ...
 */
async function setContactFrSetting(input) {
  return dynadotRest({
    method: "PUT",
    path: "/contacts/{contact_id}/set_fr_setting",
    fields: [
