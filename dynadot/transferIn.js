/**
 * POST /restful/v2/domains/{domain_name}/transfer_in
 * @see https://www.dynadot.com/domain/api-document#transfer_in
 * @param {Object} input
 ...
 * @param {boolean} [input.transfer_premium]
 * @param {string} [input.coupon_code]
 * @returns {Promise<Object>}
 */
async function transferIn(input) {
  return dynadotRest({
    method: "POST",
    path: "/domains/{domain_name}/transfer_in",
    fields: [
      ...
      { name: "transfer_premium", in: "body", type: "boolean" },
