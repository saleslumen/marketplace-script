/**
 * PUT /restful/v2/accounts/default_email_forwarding
 * @see https://www.dynadot.com/domain/api-document#set_default_email_forwarding
 * @param {Object} input
 ...
 */
async function setDefaultEmailForwarding(input) {
  return dynadotRest({
    method: "PUT",
    path: "/accounts/default_email_forwarding",
    fields: [
