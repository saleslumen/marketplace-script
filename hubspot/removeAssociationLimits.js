/**
 * @description Remove association limits. POST /crm/associations/{apiVersion}/definitions/configurations/{fromObjectType}/{toObjectType}/batch/purge. inputs is required.
 * @param {Object} input
 ...
 */
async function removeAssociationLimits(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/definitions/configurations/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/purge`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
