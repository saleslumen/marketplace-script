/**
 * @description Get the information on any import. GET /crm/imports/{apiVersion}/{importId}.
 * @param {Object} input
 ...
 */
async function getImport(input) {
  const req = inputObject(input);
  const importId = requiredPath(req, "importId");
  return requestJson(`/crm/imports/${configuredApiVersion()}/${encodeURIComponent(importId)}`, "GET");
}
