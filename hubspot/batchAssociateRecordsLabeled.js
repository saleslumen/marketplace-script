/**
 * @description Associate records (labeled). POST /crm/associations/{apiVersion}/{fromObjectType}/{toObjectType}/batch/create. inputs is required.
 * @param {Object} input
 ...
 */
async function batchAssociateRecordsLabeled(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/create`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
