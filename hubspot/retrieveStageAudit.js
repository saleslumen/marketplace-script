/**
 * @description Retrieve stage audit. GET /crm/pipelines/{apiVersion}/{objectType}/{pipelineId}/stages/{stageId}/audit.
 * @param {Object} input
 ...
 */
async function retrieveStageAudit(input) {
  ...
  return requestJson(`/crm/pipelines/${configuredApiVersion()}/${encodeURIComponent(objectType)}/${encodeURIComponent(pipelineId)}/stages/${encodeURIComponent(stageId)}/audit`, "GET");
}
