/**
 * @description Retrieve stage. GET /crm/pipelines/{apiVersion}/{objectType}/{pipelineId}/stages/{stageId}.
 * @param {Object} input
 ...
 */
async function retrievePipelineStage(input) {
  ...
  return requestJson(`/crm/pipelines/${configuredApiVersion()}/${encodeURIComponent(objectType)}/${encodeURIComponent(pipelineId)}/stages/${encodeURIComponent(stageId)}`, "GET");
}
