/**
 * @description Batch configure association limits between two object types. POST /crm/associations/{apiVersion}/definitions/configurations/{fromObjectType}/{toObjectType}/batch/create. inputs is required.
 * @param {Object} input
 ...
 */
async function batchCreateLabels(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/definitions/configurations/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/create`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
