/**
 * @description Remove associations. POST /crm/associations/{apiVersion}/{fromObjectType}/{toObjectType}/batch/archive. inputs is required.
 * @param {Object} input
 ...
 */
async function removeAssociations(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/archive`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
