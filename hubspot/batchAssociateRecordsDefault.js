/**
 * @description Associate records (default). POST /crm/associations/{apiVersion}/{fromObjectType}/{toObjectType}/batch/associate/default. inputs is required.
 * @param {Object} input
 ...
 */
async function batchAssociateRecordsDefault(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/associate/default`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
