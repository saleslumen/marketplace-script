/**
 * @description Update association limits. POST /crm/associations/{apiVersion}/definitions/configurations/{fromObjectType}/{toObjectType}/batch/update. inputs is required.
 * @param {Object} input
 ...
 */
async function updateAssociationLimits(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/definitions/configurations/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/update`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
