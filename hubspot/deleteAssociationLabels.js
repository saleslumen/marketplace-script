/**
 * @description Delete specific labels. POST /crm/associations/{apiVersion}/{fromObjectType}/{toObjectType}/batch/labels/archive. inputs is required.
 * @param {Object} input
 ...
 */
async function deleteAssociationLabels(input) {
  ...
  return requestJson(`/crm/associations/${configuredApiVersion()}/${encodeURIComponent(fromObjectType)}/${encodeURIComponent(toObjectType)}/batch/labels/archive`, "POST", bodyFrom(req, ["fromObjectType", "toObjectType"]));
}
