/**
 * @description Export one person with email. POST /v1/people/export/single.
 * @param {Object} input
 ...
 */
async function exportSinglePerson(input) {
  return aiarkRequest("/v1/people/export/single", "POST", requireIdOrUrl(input));
}
