/**
 * @description Complete a campaign from draft, or from paused with no in-flight work.
 * @param {Object} input
 ...
 */
async function completeCampaign(input) {
  return Campaigns.completeCampaign(input);
}
