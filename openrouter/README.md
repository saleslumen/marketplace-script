...
OpenRouter chat operations for a Saleslumen Marketplace app. Each operation is one function. `http.js` is shared request code.
...
Paste the OpenRouter API key. The app sends it as a bearer token. The app calls `https://openrouter.ai`.
