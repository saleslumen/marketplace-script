/**
 * @description Enable email forwarding. POST /v2/domains/email-forwarding.
 * @param {Object} input
 ...
 */
async function enableEmailForwarding(input) {
  ...
  return zapmailRequest("/v2/domains/email-forwarding", "POST", { serviceProvider, workspaceKey, body });
}
