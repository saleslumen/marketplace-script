/**
 * @description Get availability of multiple domain names. POST /v2/domains/available-bulk.
 * @param {Object} input
 ...
 */
async function checkDomainAvailability(input) {
  ...
  return zapmailRequest("/v2/domains/available-bulk", "POST", { serviceProvider, workspaceKey, body });
}
