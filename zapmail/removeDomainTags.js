/**
 * @description Remove Tags From Domains. POST /v2/domains/tags/remove.
 * @param {Object} input
 ...
 */
async function removeDomainTags(input) {
  ...
  return zapmailRequest("/v2/domains/tags/remove", "POST", { serviceProvider, workspaceKey, body });
}
