/**
 * @description Add Billing Details. POST /v2/billing.
 * @param {Object} input
 ...
 */
async function createBillingDetails(input) {
  ...
  return zapmailRequest("/v2/billing", "POST", { serviceProvider, workspaceKey, body });
}
