/**
 * @description Cancel Subscription. POST /v2/placement-tests/cancel-subscription.
 * @param {Object} input
 ...
 */
async function cancelPlacementTestSubscription(input) {
  ...
  return zapmailRequest("/v2/placement-tests/cancel-subscription", "POST", { serviceProvider, workspaceKey, body });
}
