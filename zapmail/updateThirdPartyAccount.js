/**
 * @description Update third party account details. PUT /v2/exports/accounts/third-party.
 * @param {Object} input
 ...
 */
async function updateThirdPartyAccount(input) {
  ...
  return zapmailRequest("/v2/exports/accounts/third-party", "PUT", { serviceProvider, workspaceKey, body });
}
