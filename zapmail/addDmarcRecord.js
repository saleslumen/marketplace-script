/**
 * @description Add DMARC record. POST /v2/domains/dmarc.
 * @param {Object} input
 ...
 */
async function addDmarcRecord(input) {
  ...
  return zapmailRequest("/v2/domains/dmarc", "POST", { serviceProvider, workspaceKey, body });
}
