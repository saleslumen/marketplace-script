/**
 * @description Get Renewal Price. POST /v2/domains/get-renewal-price.
 * @param {Object} input
 ...
 */
async function getRenewalPrice(input) {
  ...
  return zapmailRequest("/v2/domains/get-renewal-price", "POST", { serviceProvider, workspaceKey, body });
}
