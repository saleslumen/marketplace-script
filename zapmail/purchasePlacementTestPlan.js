/**
 * @description Purchase plan. POST /v2/placement-tests/purchase-plan.
 * @param {Object} input
 ...
 */
async function purchasePlacementTestPlan(input) {
  ...
  return zapmailRequest("/v2/placement-tests/purchase-plan", "POST", { serviceProvider, workspaceKey, body });
}
