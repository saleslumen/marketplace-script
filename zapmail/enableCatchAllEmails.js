/**
 * @description Enable catch all emails. POST /v2/domains/catch-all.
 * @param {Object} input
 ...
 */
async function enableCatchAllEmails(input) {
  ...
  return zapmailRequest("/v2/domains/catch-all", "POST", { serviceProvider, workspaceKey, body });
}
