/**
 * @description Get all subscriptions. GET /v2/subscriptions.
 * @param {Object} input
...
async function listSubscriptions(input) {
  ...
  return zapmailRequest(withQuery("/v2/subscriptions", req, ["status", "contains"]), "GET", { serviceProvider, workspaceKey });
}
