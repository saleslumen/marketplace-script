/**
 * @description Get DMARC Report Failures. GET /api/v1/dmarc-reports/domains/{domain_uuid}/dmarc-failures.
 * @param {Object} input
...
async function getDmarcReportFailures(input) {
  ...
  return emailguardRequest(`/api/v1/dmarc-reports/domains/${encodeURIComponent(domain_uuid)}/dmarc-failures`, "GET", query);
}
